...
<!--&lt;!&ndash;                                    <NavLink v-if="$page.props.auth.user" :href="route('assemblies.show', assembly.id)" classes="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 ml-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">&ndash;&gt;-->
<!--&lt;!&ndash;                                        Bekijk&ndash;&gt;-->
<!--&lt;!&ndash;                                    </NavLink>&ndash;&gt;-->
<!--&lt;!&ndash;                                    <NavLink v-if="$page.props.auth.user?.is_admin" :href="route('assemblies.edit', assembly.id)" classes="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 ml-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">&ndash;&gt;-->
<!--&lt;!&ndash;                                        Bewerk&ndash;&gt;-->
<!--&lt;!&ndash;                                    </NavLink>&ndash;&gt;-->
<!--&lt;!&ndash;                                    <NavLink v-if="$page.props.auth.user?.is_admin" @click="destroy(assembly.id)" classes="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-3 py-1.5 ml-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">&ndash;&gt;-->
<!--&lt;!&ndash;                                        Verwijder&ndash;&gt;-->
<!--&lt;!&ndash;                                    </NavLink>&ndash;&gt;-->
<!--                                </td>-->
                            </tr>
                            </tbody>
